...
namespace EpicBattleFantasyUltimate.Projectiles.StaffProjectiles
{
	...
	{
		int DrainTimer = 60;
		float SuckRange = 1600f;

		List<Dust> effectDusts = new List<Dust>(); // create a list of dust object
		float dustSpeed = 5f; //how fast the dust moves
		float dustBoost = 2f; //The offset from the center from which the dust will spawn
		int dustSpawnRate = 100; //bigger = more dust, total dust is dustSpawnTime*dustSpawnRate
