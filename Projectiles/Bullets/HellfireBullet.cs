...
namespace EpicBattleFantasyUltimate.Projectiles.Bullets
{
    public class HellfireBullet : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            int a = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, ModContent.ProjectileType<HellfireExplosion>(), 70, 0, Projectile.owner);
        }
    }
}