...
namespace EpicBattleFantasyUltimate.Projectiles.SpellProjectiles
{
    public class Fireball : ModProjectile
    {
        ...
        {
            int a = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y - 16f, 0f, 0f, mod.ProjectileType("FireballBig"), (int)(projectile.damage * 1f), 0, projectile.owner);
