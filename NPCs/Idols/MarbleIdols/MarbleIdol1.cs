...
namespace EpicBattleFantasyUltimate.NPCs.Idols.MarbleIdols
{
    public class MarbleIdol1 : ModNPC
    {
        ...
        public override bool CheckDead()
        {
            if (Drop == false)
            {
                int goreIndex = Gore.NewGore(npc.position, (npc.velocity * npc.direction), mod.GetGoreSlot("Gores/Idols/MarbleIdols/MarbleIdol1/MarbleIdol1_Gore1"), 1f);
            }
            int goreIndex2 = Gore.NewGore(npc.position, (npc.velocity * npc.direction) * -1, mod.GetGoreSlot("Gores/Idols/MarbleIdols/MarbleIdol1/MarbleIdol1_Gore2"), 1f);
            int goreIndex3 = Gore.NewGore(npc.position, (npc.velocity * npc.direction), mod.GetGoreSlot("Gores/Idols/MarbleIdols/MarbleIdol1/MarbleIdol1_Gore3"), 1f);
            int goreIndex4 = Gore.NewGore(npc.position, (npc.velocity * npc.direction) * -1, mod.GetGoreSlot("Gores/Idols/MarbleIdols/MarbleIdol1/MarbleIdol1_Gore4"), 1f);
