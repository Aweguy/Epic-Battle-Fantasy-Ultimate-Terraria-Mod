...
namespace EpicBattleFantasyUltimate.NPCs.Idols.MarbleIdols
{
    public class MarbleIdol3 : ModNPC
    {
        ...
        public override bool CheckDead()
        {
            if (Drop == false)
            {
                int goreIndex = Gore.NewGore(NPC.position, (NPC.velocity * NPC.direction), Mod.Find<ModGore>("MarbleIdol3_Gore1").Type, 1f);
            }
            int goreIndex2 = Gore.NewGore(NPC.position, (NPC.velocity * NPC.direction) * -1, Mod.Find<ModGore>("MarbleIdol3_Gore2").Type, 1f);
            int goreIndex3 = Gore.NewGore(NPC.position, (NPC.velocity * NPC.direction), Mod.Find<ModGore>("MarbleIdol3_Gore3").Type, 1f);
            int goreIndex4 = Gore.NewGore(NPC.position, (NPC.velocity * NPC.direction) * -1, Mod.Find<ModGore>("MarbleIdol3_Gore4").Type, 1f);
