...
namespace EpicBattleFantasyUltimate.NPCs.Idols.WoodenIdols
{
    public class WoodenIdol2 : ModNPC
    {
        ...
        {
            int goreIndex = Gore.NewGore(NPC.position, (NPC.velocity * NPC.direction), Mod.Find<ModGore>("WoodenIdol2_Gore1").Type, 1f);
            int goreIndex2 = Gore.NewGore(NPC.position, (NPC.velocity * NPC.direction) * -1, Mod.Find<ModGore>("WoodenIdol2_Gore2").Type, 1f);
