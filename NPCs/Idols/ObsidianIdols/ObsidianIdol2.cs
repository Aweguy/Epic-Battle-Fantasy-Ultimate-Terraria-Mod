...
namespace EpicBattleFantasyUltimate.NPCs.Idols.ObsidianIdols
{
    public class ObsidianIdol2 : ModNPC
    {
        ...
        public override bool CheckDead()
        {
            ...
            int goreIndex = Gore.NewGore(npc.position, (npc.velocity * npc.direction), mod.GetGoreSlot("Gores/Idols/ObsidianIdols/ObsidianIdol2/ObsidianIdol2_Gore1"), 1f);
            int goreIndex2 = Gore.NewGore(npc.position, (npc.velocity * npc.direction) * -1, mod.GetGoreSlot("Gores/Idols/ObsidianIdols/ObsidianIdol2/ObsidianIdol2_Gore2"), 1f);
            int goreIndex3 = Gore.NewGore(npc.position, (npc.velocity * npc.direction), mod.GetGoreSlot("Gores/Idols/ObsidianIdols/ObsidianIdol2/ObsidianIdol2_Gore3"), 1f);
            int goreIndex4 = Gore.NewGore(npc.position, (npc.velocity * npc.direction) * -1, mod.GetGoreSlot("Gores/Idols/ObsidianIdols/ObsidianIdol2/ObsidianIdol2_Gore4"), 1f);
