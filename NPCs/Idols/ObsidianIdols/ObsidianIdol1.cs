...
{
    public class ObsidianIdol1 : ModNPC
    {
        int FireballTimer = 60 * 5;
        bool Left = false;
        bool Right = true;
        bool Spin = false;
        ...
        public override bool CheckDead()
        {
            ...
            int goreIndex = Gore.NewGore(npc.position, (npc.velocity * npc.direction), mod.GetGoreSlot("Gores/Idols/ObsidianIdols/ObsidianIdol1/ObsidianIdol1_Gore1"), 1f);
            int goreIndex2 = Gore.NewGore(npc.position, (npc.velocity * npc.direction) * -1, mod.GetGoreSlot("Gores/Idols/ObsidianIdols/ObsidianIdol1/ObsidianIdol1_Gore2"), 1f);
            int goreIndex3 = Gore.NewGore(npc.position, (npc.velocity * npc.direction), mod.GetGoreSlot("Gores/Idols/ObsidianIdols/ObsidianIdol1/ObsidianIdol1_Gore3"), 1f);
            int goreIndex4 = Gore.NewGore(npc.position, (npc.velocity * npc.direction) * -1, mod.GetGoreSlot("Gores/Idols/ObsidianIdols/ObsidianIdol1/ObsidianIdol1_Gore4"), 1f);
